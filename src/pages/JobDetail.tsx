...
export const JobDetail: React.FC<JobDetailProps> = ({ jobs }) => {
  const { id } = useParams();
    ...
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-4">
           <button className="text-gray-500 hover:text-gold-primary transition-colors flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="px-8 pb-8 -mt-12 relative z-10">
              <div className="flex flex-col md:flex-row gap-6 items-end justify-between">
                ...
                <div className="flex gap-3 w-full md:w-auto mt-6 md:mt-0">
                  <button className="flex-1 md:flex-none px-10 h-14 bg-gold-gradient text-background-dark font-black rounded-full uppercase tracking-widest shadow-xl shadow-gold-primary/20 hover:scale-[1.03] active:scale-95 transition-all flex items-center justify-center gap-2">
                    Candidatar-me
                  </button>
                  <button className="px-5 h-14 border border-gold-primary/40 text-gold-primary hover:bg-gold-primary/10 transition-all rounded-full flex items-center justify-center">
          ...
          {/* LINHA DE TALENTO - The Requested Refinement */}
          <div className="glass-card rounded-2xl p-10 border border-gold-primary/30 bg-gold-primary/5 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Contact Card: Phone - Matches image style */}
                <div className="flex flex-col gap-4">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 sticky top-28">
          ...
          <div className="glass-card rounded-2xl p-8 border border-border-gold bg-surface-dark/40 shadow-lg">
            ...
            <div className="flex flex-col gap-6">
              {jobs.filter(j => j.id !== id).slice(0, 3).map(other => (
